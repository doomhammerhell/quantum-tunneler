...
|---|---|---|
| [RFC 7296 / STD 79](https://www.rfc-editor.org/info/rfc7296/) | Internet Standard, with subsequent updates | Partial structural parser and PRF schedule arithmetic; authenticated IKE unavailable |
| [RFC 4301](https://www.rfc-editor.org/rfc/rfc4301.html) | IPsec security architecture | Referenced; directional SA ownership only, no complete SPD/SAD gateway |
